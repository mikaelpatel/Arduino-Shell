...
The shell is constructed with a stack and a variable table. The size
...
within the variable block (0..VAR_MAX-1). The variable may hold
pointers to scripts (assigned in the sketch).
```
Shell<16,16> shell(Serial);
...
const char* blink = "13H1000D13L1000D";
shell.write(0, blink);
```
